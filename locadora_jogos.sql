...
CREATE OR REPLACE FUNCTION log_alteracao_preco_trigger_func()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER tg_log_alteracao_preco
    ...
    FOR EACH ROW
    EXECUTE FUNCTION log_alteracao_preco_trigger_func();
...
GRANT EXECUTE ON FUNCTION verificar_disponibilidade_jogo TO funcionario_locadora;
...
GRANT EXECUTE ON FUNCTION verificar_disponibilidade_jogo TO cliente_locadora;
